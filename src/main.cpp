...
const char *wifi_ssid = "iPhone de Hugo";
const char *wifi_password = "hugo est trop fort en physique";
...
const char *client_id = "TD06_GPO6";
...
void setup()
{
  ...
  {
    mqtt_client.publish("TD06_GP06/temp", String(temp_measure).c_str());
    mqtt_client.publish("TD06_GP06/relhum", String(relative_humidity_measure).c_str());
  }
  else
  {
